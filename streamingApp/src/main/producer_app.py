...
class ProducerApp:
    ...
    def __init__(self, config_path='configs/application.conf', log_path='logs/producer_app.log'):
...
if __name__ == "__main__":
    app = ProducerApp(config_path='configs/application.conf', log_path='logs/producer_app.log')
    app.stream_to_kafka()
